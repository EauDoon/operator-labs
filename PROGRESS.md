...
| 2 | Corridor Lab desktop workbench (controller + tabbed GUI + structured transaction edits + baseline diff) | done (ea09baf) |
| 3 | TraceCanary guided investigation workflow (controller + grouped GUI + batch directories + starter additions) | done |
| 4 | Documentation and quick starts around the finished workflows | in progress |
